...
export default class TaskRepository {
  ...
  // repositorio para buscar tareas en un querystring segun estado DONE de un usuario logueado
  public readonly findAllTask = async (done: boolean): Promise<TaskDTO[]> => {
